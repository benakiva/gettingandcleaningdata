...
# Create the combined test set by merging the xTest, yTest and subjectTest data
...
cleanData = merge(tidyData,activityType,by='activityId',all.x=TRUE);

# Export the tidyData set 
write.table(cleanData, './tidy.txt',row.names=TRUE,sep='\t');